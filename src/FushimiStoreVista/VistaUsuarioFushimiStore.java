...
public class VistaUsuarioFushimiStore extends javax.swing.JFrame {

    public VistaUsuarioFushimiStore() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FushimiStoreImg/LogoBunnyCatLogo.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaUsuarioFushimiStore.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new VistaUsuarioFushimiStore().setVisible(true);
        });
    }
